      ...
      <ScrollView >
        ...
        <Text style={styles.foodTitle}>{recipe.recipeName}</Text>
         ...
         <View style={styles.quantityControl}>
          ...
          <Text style={styles.foodDescription}>{recipe.description || "No description available."}</Text>
...
const styles = StyleSheet.create({
  ...
  rating: { flexDirection: "row", alignItems: "center", backgroundColor: "#4BB842", padding: 8, borderRadius: 20, width:65 },
